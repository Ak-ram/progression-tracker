...
class Brand extends Component {
  ...
  render() {
    return (
      <Fragment>
        <div>
          <Link to="/" className="d-flex navbar-brand col m-0 p-0">
            <svg
              viewBox="0 0 111 30"
              focusable="false"
              id="brand"
              className="svgIconNetflixBrand d-none d-sm-inline-block"
            >
              <g>
                <path
            ...
            <span className="d-none d-sm-block px-sm-3 mx-sm-3 brand-head text-capitalize border-start border-2">
              {this.props["brand-head"]}
            </span>
          </Link>
        </div>
      </Fragment>
